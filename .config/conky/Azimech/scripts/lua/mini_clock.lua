...
seconds_ring_width       = 19,               -- seconds ring width
seconds_ring_base_color  = {0xC4C4C4, 0.4}, -- base color
seconds_ring_fill_color  = {0xFFFFFF, 1}, -- fill color
seconds_ring_fill_colorS = {0xFFFFFF, 1},

-- Main settings
xc = 455, -- centre of the clock
yc = 80,
R  = 67, -- default radius of the clock
...
rs = 2,  -- seconds ring fill radius
border_width = 0, -- radius border fill ring

-- Color settings. {color, alpha}
background_color = {0xC4C4C4, 0.6}, -- bgcolor id draw_background is true.
fill_color       = {0xFFFFFF, 0},   -- fill color for hour+minutes ring
fill_colorS      = {0xFFFFFF, 0},   -- fill color for seconds ring
