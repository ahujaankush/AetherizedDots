...
dummy_keyboardlayout_widget:connect_signal("widget::redraw_needed", function ()
    notif = notifications.notify_dwim({ title = "Keyboard layout", message = dummy_keyboardlayout_widget.widget.text:upper(), icon = icons.getIcon("elenaLinebit/keyboard.png"), timeout = 1, app_name = "keyboard" }, notif)
end)
